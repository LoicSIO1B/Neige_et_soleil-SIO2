...
if ( (isset($_GET['logement'])) && (!(empty($_GET['logement']))) )
    $_SESSION['sel_tri_logement'] = $_GET['logement'] ;

//choix du calendrier en fonction d'unlogement spécifique ou tous les logements
...
<link href="index_tous.css" rel="stylesheet" type="text/css">
</head>
<body>
<div id="container">
<div id="wb_MasterPage4" style="position:absolute;left:2px;top:0px;width:964px;height:110px;z-index:30;">
</div>
<div id="wb_MasterPage2" style="position:absolute;left:4px;top:0px;width:96px;height:106px;z-index:31;">
...
<div id="wb_MasterPage1" style="position:absolute;left:4px;top:0px;width:998px;height:110px;z-index:32;">
...
<div id="index_calendrierLayer1" style="position:absolute;text-align:left;left:4px;top:110px;width:994px;height:2000px;z-index:33;">
<div id="index_calendrierHtml1" style="position:absolute;left:2px;top:0px;width:989px;height:180px;z-index:29">
<?php

// chemin vers le fichier  calendrier.php *************
  include("calendrier_tous.php");
