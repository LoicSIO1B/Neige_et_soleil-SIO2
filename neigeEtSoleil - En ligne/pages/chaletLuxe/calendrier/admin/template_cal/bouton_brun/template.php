...
$couleur_police_numero_semaine = "#EBEBEB" ;
$police = "Arial" ;
...
$couleur_nom_numero_semaine = "#A1844F" ;
$couleur_numero_semaine = "#C69E73" ;
$couleur_jour_semaine = "#A1844F" ;
$couleur_nom_jour_week_end = "#BA995B" ;
$couleur_jour_week_end = "#C69E73" ;
$bordure_ligne_fin_semaine = 1 ;
$couleur_ligne_fin_semaine = "#FF0000" ;
$avec_continuite_couleur = true ;
$couleur_fond_mois = "#7A643C" ;
$url_image_fond_mois = "template_cal/bouton_brun/img0011.gif" ;
$alignement_horizontal_image_fond = "center" ;
$alignement_vertical_image_fond = "top" ;
$couleur_libre = "#C69E73" ;
$url_image_fond_cellule = "template_cal/bouton_brun/img0011.gif" ;
$url_image_fond_cellule_week_end = "template_cal/bouton_brun/img0011.gif" ;
$url_image_fond_cellule_nom_jour = "template_cal/bouton_brun/img0011.gif" ;
$url_image_fond_cellule_numero_semaine = "template_cal/bouton_brun/img0011.gif" ;
$couleur_bordure_cellule_non_vide = "#EBE9C5" ;
