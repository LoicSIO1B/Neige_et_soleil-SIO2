...
$couleur_police_nom_jour = "#FAFAFA" ;
...
$couleur_bordure_tableau = "#FCF5F5" ;
$hauteur_mini_cellule_date = 22 ;
$largeur_tableau = 168 ;
$avec_affichage_numero_semaine = true ;

$couleur_nom_numero_semaine = "#C4C100" ;
$couleur_numero_semaine = "#E1E8A6" ;
$couleur_jour_semaine = "#C4C100" ;
$couleur_nom_jour_week_end = "#A3A100" ;
$couleur_jour_week_end = "#CED498" ;
$bordure_ligne_fin_semaine = 1 ;
$couleur_ligne_fin_semaine = "#FF0000" ;
$avec_continuite_couleur = true ;
$couleur_fond_mois = "#FFFDFC" ;
$url_image_fond_mois = "template_cal/ruban_vert/ruban_green_1.gif" ;
