...
$couleur_numero_semaine = "#C9D2FF" ;
$couleur_jour_semaine = "#2B2B2B" ;
$couleur_nom_jour_week_end = "#2B2B2B" ;
$couleur_jour_week_end = "#C9D2FF" ;
$bordure_ligne_fin_semaine = 1 ;
$couleur_ligne_fin_semaine = "#FF0000" ;
$avec_continuite_couleur = true ;
$couleur_fond_mois = "#C9D2FF" ;
$url_image_fond_mois = "template_cal/bouton_bleu_noir/img0004.gif" ;
$alignement_horizontal_image_fond = "center" ;
$alignement_vertical_image_fond = "center" ;
$couleur_libre = "#C9D2FF" ;
$url_image_fond_cellule = "template_cal/bouton_bleu_noir/img0009.gif" ;
$url_image_fond_cellule_week_end = "template_cal/bouton_bleu_noir/img0009.gif" ;
$url_image_fond_cellule_nom_jour = "template_cal/bouton_bleu_noir/img0005.gif" ;
$url_image_fond_cellule_numero_semaine = "template_cal/bouton_bleu_noir/img0009.gif" ;
