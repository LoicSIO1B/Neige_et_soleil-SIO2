...
$couleur_police_jour = "#F7F7F7" ;
$couleur_police_numero_semaine = "#F2F2F2" ;
$police = "Arial" ;
...
$couleur_numero_semaine = "#5C5C5C" ;
$couleur_jour_semaine = "#2B2B2B" ;
$couleur_nom_jour_week_end = "#2B2B2B" ;
$couleur_jour_week_end = "#5C5C5C" ;
$bordure_ligne_fin_semaine = 1 ;
$couleur_ligne_fin_semaine = "#FF0000" ;
$avec_continuite_couleur = true ;
$couleur_fond_mois = "#000000" ;
$url_image_fond_mois = "template_cal/noir_c_noir/img0004.gif" ;
$alignement_horizontal_image_fond = "center" ;
$alignement_vertical_image_fond = "center" ;
$couleur_libre = "#5C5C5C" ;
$url_image_fond_cellule = "template_cal/noir_c_noir/img0004.gif" ;
$url_image_fond_cellule_week_end = "template_cal/noir_c_noir/img0004.gif" ;
$url_image_fond_cellule_nom_jour = "template_cal/noir_c_noir/img0004.gif" ;
$url_image_fond_cellule_numero_semaine = "template_cal/noir_c_noir/img0005.gif" ;
$couleur_bordure_cellule_non_vide = "#BABABA" ;
