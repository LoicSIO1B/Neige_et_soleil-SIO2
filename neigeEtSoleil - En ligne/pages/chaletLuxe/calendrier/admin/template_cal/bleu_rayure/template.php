...
$couleur_nom_numero_semaine = "#C7E9FC" ;
$couleur_numero_semaine = "#C7E9FC" ;
$couleur_jour_semaine = "#FFFFFF" ;
$couleur_nom_jour_week_end = "#59C3E3" ;
$couleur_jour_week_end = "#59C3E3" ;
$bordure_ligne_fin_semaine = 1 ;
$couleur_ligne_fin_semaine = "#FF0000" ;
$avec_continuite_couleur = true ;
$couleur_fond_mois = "#4AA2BD" ;
$url_image_fond_mois = "template_cal/bleu_rayure/img0009.gif" ;
