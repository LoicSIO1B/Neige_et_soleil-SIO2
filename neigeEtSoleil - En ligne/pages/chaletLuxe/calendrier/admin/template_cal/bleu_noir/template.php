...
$couleur_police_jour = "#5AAABD" ;
$couleur_police_numero_semaine = "#5AAABD" ;
$police = "Arial" ;
...
$couleur_nom_numero_semaine = "#5AAABD" ;
$couleur_numero_semaine = "#575757" ;
$couleur_jour_semaine = "#5AAABD" ;
$couleur_nom_jour_week_end = "#5AAABD" ;
$couleur_jour_week_end = "#575757" ;
$bordure_ligne_fin_semaine = 1 ;
$couleur_ligne_fin_semaine = "#FF0000" ;
$avec_continuite_couleur = true ;
$couleur_fond_mois = "#2996C6" ;
$url_image_fond_mois = "template_cal/bleu_noir/img0007.gif" ;
