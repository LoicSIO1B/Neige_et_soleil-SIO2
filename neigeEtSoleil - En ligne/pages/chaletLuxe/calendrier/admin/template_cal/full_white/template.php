...
$couleur_nom_numero_semaine = "#FFFAFA" ;
$couleur_numero_semaine = "#FFFAFA" ;
$couleur_jour_semaine = "#FFFAFA" ;
$couleur_nom_jour_week_end = "#FFFAFA" ;
$couleur_jour_week_end = "#FFFAFA" ;
$bordure_ligne_fin_semaine = 1 ;
$couleur_ligne_fin_semaine = "#FF0000" ;
$avec_continuite_couleur = true ;
$couleur_fond_mois = "#FFFAFA" ;
$url_image_fond_mois = "" ;
$alignement_horizontal_image_fond = "center" ;
$alignement_vertical_image_fond = "top" ;
$couleur_libre = "#FFFAFA" ;
...
$couleur_separateur_calendrier_tous = "#C4C3A5" ;




$choix_modele = "full_white" ;
