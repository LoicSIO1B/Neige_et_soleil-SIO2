			...
			<section class="contenu ombre">
				...
				<div class="container2">  
				  <form id="contact" action="" method="post">
				    ...
				    <fieldset>
				      <textarea placeholder="Entrez votre message ici...." name="msg" tabindex="6" style="width: 250px; height: 200px; margin-left: 30%; margin-bottom: 5px;" required></textarea>
				    </fieldset>
				    <fieldset>
				      <button name="submit" type="submit" id="contact-submit" style="margin-left: 50%;" data-submit="...Sending">Envoyer</button>
				    </fieldset>
				  </form>
				</div>
				...
				<?php
				  if(isset($_POST) && !empty($_POST['nom']) && !empty($_POST['prenom']) && !empty($_POST['mail']) && !empty($_POST['tel']) && !empty($_POST['age']) && !empty($_POST['msg'])){
				      ...
				      $mail=mail($destinataire, "De MesGarants.com : Contact", $expediteur, $msg);
