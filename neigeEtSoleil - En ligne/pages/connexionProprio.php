...
if(isset($_POST['formconnexion']))
{
	...
	{
		$requser = $bdd->prepare("SELECT * FROM proprietaire WHERE mailPro = ?  AND motdepassePro = ?");
		$requser->execute(array($mailconnect, $mdpconnect));
		$userexist = $requser->rowCount();
		if($userexist == 1)
		{
			$userinfo = $requser->fetch();
			$_SESSION['id'] = $userinfo['idPro'];
			$_SESSION['nom'] = $userinfo['nomPro'];
			$_SESSION['mail'] = $userinfo['mailPro'];
			...
			<section class="contenu ombre">
				<section class="contenu ombre">
					<div align="center">
						<div id="tabs">
						<ul>
						     <li><a href="connexion.php" onclick="loadit(this)" >Client</a></li>
						     <li><a href="connexionProprio.php" onclick="loadit(this)" class="selected">Propriétaire</a></li>
						</ul>
					</div>			<style>
				.legal
				{
				...
				iframe
				{
				    ...
				    padding:0;
						...
						<form method ="POST" action="">
							...
							<br/>
							<p>Pas encore de compte ? <a href="inscriptionProprio.php">Inscrivez-vous !</a></p>
						</form>
						<br>
						<?php
						if(isset($erreur))
