...
$couleur_nom_numero_semaine = "#E1EBEA" ;
$couleur_numero_semaine = "#E1EBEA" ;
$couleur_jour_semaine = "#D5DEDD" ;
$couleur_nom_jour_week_end = "#C6CFCE" ;
$couleur_jour_week_end = "#C6CFCE" ;
$bordure_ligne_fin_semaine = 1 ;
$couleur_ligne_fin_semaine = "#FF0000" ;
$avec_continuite_couleur = true ;
$couleur_fond_mois = "#7D7D7D" ;
$url_image_fond_mois = "" ;
$alignement_horizontal_image_fond = "left" ;
$alignement_vertical_image_fond = "top" ;
$couleur_libre = "#EFEFEF" ;
