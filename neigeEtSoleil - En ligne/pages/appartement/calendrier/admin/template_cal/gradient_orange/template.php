...
$couleur_police_nom_jour = "#FCFCFC" ;
$taille_police_jour = 12 ;
$couleur_police_jour = "#2E2E2E" ;
$couleur_police_numero_semaine = "#F5F5F5" ;
$police = "Arial" ;
...
$couleur_nom_numero_semaine = "#C99A16" ;
$couleur_numero_semaine = "#E3AE19" ;
$couleur_jour_semaine = "#C99A16" ;
$couleur_nom_jour_week_end = "#E3AE19" ;
$couleur_jour_week_end = "#F0B81A" ;
$bordure_ligne_fin_semaine = 1 ;
$couleur_ligne_fin_semaine = "#FF0000" ;
$avec_continuite_couleur = true ;
$couleur_fond_mois = "#785C0D" ;
$url_image_fond_mois = "" ;
$alignement_horizontal_image_fond = "center" ;
$alignement_vertical_image_fond = "top" ;
$couleur_libre = "#FFEFAD" ;
