...
$couleur_police_jour = "#FAFAFA" ;
$couleur_police_numero_semaine = "#FAFAFA" ;
$police = "Arial" ;
...
$couleur_nom_numero_semaine = "#F5F5F5" ;
$couleur_numero_semaine = "#2B2A00" ;
$couleur_jour_semaine = "#FAFAFA" ;
$couleur_nom_jour_week_end = "#EDEDED" ;
$couleur_jour_week_end = "#45453E" ;
$bordure_ligne_fin_semaine = 1 ;
$couleur_ligne_fin_semaine = "#FF0000" ;
$avec_continuite_couleur = true ;
$couleur_fond_mois = "#5C5C5A" ;
$url_image_fond_mois = "" ;
$alignement_horizontal_image_fond = "center" ;
$alignement_vertical_image_fond = "top" ;
$couleur_libre = "#8A8C85" ;
