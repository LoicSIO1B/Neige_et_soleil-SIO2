...
$couleur_police_mois = "#5E5E5E" ;
$taille_police_nom_jour = 12 ;
$couleur_police_nom_jour = "#EDF7F7" ;
$taille_police_jour = 12 ;
$couleur_police_jour = "#69737D" ;
...
$couleur_nom_numero_semaine = "#B1B4BA" ;
$couleur_numero_semaine = "#B1B4BA" ;
$couleur_jour_semaine = "#B8BCC2" ;
$couleur_nom_jour_week_end = "#B8BCC2" ;
$couleur_jour_week_end = "#E6EBF2" ;
