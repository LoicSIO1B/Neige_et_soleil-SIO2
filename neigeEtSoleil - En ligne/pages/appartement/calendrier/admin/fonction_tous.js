...
function ajout_date(date, nb_jour)
{
 ...
 if ( choix_selecteur_debut ) {   // champs de date début
    ...
    document.getElementById('logement_debut').value=id_logement;
    document.getElementById('affiche_logement').value=nom_logement[id_logement];
    ...
    if  ( format_cal == 'calendrier_periode') {
        ...
        document.getElementById('logement_fin').value=id_logement;
    }
    ...
    if  ( val_date_fin != 'JJ/MM/AAAA') {

      val_logement_fin = document.getElementById('logement_fin').value;
      if  ( val_logement_fin != id_logement ) {   // controle si le logement de date debut et le meme que le logement date fin
          document.getElementById('date_debut').value = 'JJ/MM/AAAA';
          document.getElementById('logement_debut').value='';
          ...
          document.getElementById('affiche_logement').value='';
          ...
          alert ('La date de début et la date de fin doivent obligatoirement\n être sélectionné pour un seul et même logement.\n Veuillez recommencer!');
          }
      }
     bordure_comm ();
    ...
    if  ( val_date_debut != 'JJ/MM/AAAA') {

      val_logement_debut = document.getElementById('logement_debut').value;
      if  ( val_logement_debut != id_logement ) {   // controle si le logement de date debut et le meme que le logement date fin
          document.getElementById('date_debut').value = 'JJ/MM/AAAA';
          document.getElementById('logement_debut').value='';
          document.getElementById('date_fin').value = 'JJ/MM/AAAA';
          document.getElementById('logement_debut').value='';
...
var strFilter = new  RegExp("^[0-9]{1,2}[/]{1}[0-9]{1,2}[/]{1}[0-9]{4}$","g");
 if ( (theForm.date_debut.value.length < 8) || (theForm.date_debut.value == 'JJ/MM/AAAA') || !strFilter.test(strValue) ) {
   alert("Vous n'avez pas renseigné la date de debut!");
   return false;
  }
...
var strFilter = new  RegExp("^[0-9]{1,2}[/]{1}[0-9]{1,2}[/]{1}[0-9]{4}$","g");
 if ( (theForm.date_fin.value.length < 8) || (theForm.date_fin.value =='JJ/MM/AAAA') || !strFilter.test(strValue) ) {
   alert("Vous n'avez pas renseigné la date de fin!");
   return false;
  }
