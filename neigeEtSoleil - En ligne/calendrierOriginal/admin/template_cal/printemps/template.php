...
$couleur_police_mois = "#717855" ;
$taille_police_nom_jour = 12 ;
$couleur_police_nom_jour = "#616878" ;
$taille_police_jour = 12 ;
$couleur_police_jour = "#781E5A" ;
$couleur_police_numero_semaine = "#04606E" ;
$police = "Arial" ;

$bordure_du_tableau = 0 ;
$couleur_bordure_tableau = "#000000" ;
$hauteur_mini_cellule_date = 17 ;
$largeur_mini_cellule_date = 18 ;
$largeur_tableau = 170 ;
$avec_affichage_numero_semaine = true ;

$couleur_nom_numero_semaine = "#C8DF6A" ;
$couleur_numero_semaine = "#C8DF6A" ;
$couleur_jour_semaine = "#C8DF6A" ;
$couleur_nom_jour_week_end = "#C8DF6A" ;
$couleur_jour_week_end = "#E6E6E6" ;
$bordure_ligne_fin_semaine = 1 ;
$couleur_ligne_fin_semaine = "#FF0000" ;
$avec_continuite_couleur = true ;
$couleur_fond_mois = "#DEECA8" ;
$url_image_fond_mois = "" ;
$alignement_horizontal_image_fond = "left" ;
$alignement_vertical_image_fond = "top" ;
$couleur_libre = "#F4F4F4" ;
...
$couleur_separateur_calendrier_tous = "#AAB581" ;




$choix_modele = "printemps" ;
