...
$couleur_police_nom_jour = "#333333" ;
...
$couleur_nom_numero_semaine = "#BDDB79" ;
$couleur_numero_semaine = "#BDDB79" ;
$couleur_jour_semaine = "#BDDB79" ;
$couleur_nom_jour_week_end = "#D8ED82" ;
$couleur_jour_week_end = "#B0E2FF" ;
$bordure_ligne_fin_semaine = 1 ;
$couleur_ligne_fin_semaine = "#FF0000" ;
$avec_continuite_couleur = true ;
$couleur_fond_mois = "#A3BD68" ;
$url_image_fond_mois = "http://127.0.0.1/test V4/admin/template_cal/bleu_vert/vert_bleu" ;
$alignement_horizontal_image_fond = "left" ;
$alignement_vertical_image_fond = "top" ;
$couleur_libre = "#70CBF8" ;
