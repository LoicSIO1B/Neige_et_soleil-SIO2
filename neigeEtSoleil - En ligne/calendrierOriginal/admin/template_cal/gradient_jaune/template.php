...
$couleur_police_mois = "#292929" ;
$taille_police_nom_jour = 12 ;
$couleur_police_nom_jour = "#3D3D3D" ;
$taille_police_jour = 12 ;
$couleur_police_jour = "#2E2E2E" ;
$couleur_police_numero_semaine = "#616161" ;
$police = "Arial" ;
...
$couleur_nom_numero_semaine = "#EBE200" ;
$couleur_numero_semaine = "#FCF300" ;
$couleur_jour_semaine = "#EBE200" ;
$couleur_nom_jour_week_end = "#FCF300" ;
$couleur_jour_week_end = "#FFF600" ;
$bordure_ligne_fin_semaine = 1 ;
$couleur_ligne_fin_semaine = "#FF0000" ;
$avec_continuite_couleur = true ;
$couleur_fond_mois = "#ABA500" ;
$url_image_fond_mois = "" ;
$alignement_horizontal_image_fond = "center" ;
$alignement_vertical_image_fond = "top" ;
$couleur_libre = "#FAFCBD" ;
