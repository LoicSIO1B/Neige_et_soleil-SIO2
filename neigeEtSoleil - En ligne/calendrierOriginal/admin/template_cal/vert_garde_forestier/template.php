...
$couleur_police_nom_jour = "#D9D9D9" ;
$taille_police_jour = 12 ;
$couleur_police_jour = "#F2EEE4" ;
$couleur_police_numero_semaine = "#F0F0F0" ;
$police = "Arial" ;
...
$couleur_nom_numero_semaine = "#8CC300" ;
$couleur_numero_semaine = "#8CC300" ;
$couleur_jour_semaine = "#8CC300" ;
$couleur_nom_jour_week_end = "#8CC300" ;
$couleur_jour_week_end = "#8CC300" ;
$bordure_ligne_fin_semaine = 1 ;
$couleur_ligne_fin_semaine = "#FF0000" ;
$avec_continuite_couleur = true ;
$couleur_fond_mois = "#8CC300" ;
$url_image_fond_mois = "template_cal/vert_garde_forestier/grand-vert.png" ;
$alignement_horizontal_image_fond = "center" ;
$alignement_vertical_image_fond = "center" ;
$couleur_libre = "#8CC300" ;
$url_image_fond_cellule = "template_cal/vert_garde_forestier/grand-vert.png" ;
$url_image_fond_cellule_week_end = "template_cal/vert_garde_forestier/grand-vert.png" ;
$url_image_fond_cellule_nom_jour = "template_cal/vert_garde_forestier/grand-vert.png" ;
$url_image_fond_cellule_numero_semaine = "template_cal/vert_garde_forestier/grand-vert.png" ;
...
$couleur_separateur_calendrier_tous = "#ACF000" ;




$choix_modele = "vert_garde_forestier" ;
